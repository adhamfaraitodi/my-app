    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h1>I'm Adham Faraitodi</h1>
          <h2>Full Stack Web Developer</h2>
          <div class="d-flex justify-content-center justify-content-lg-start">
            <a href="#footer" class="btn-get-started scrollto">Contact Me</a>
            <a href="https://www.youtube.com/watch?v=pUTz5IOkBtE&t=6364s" class="glightbox btn-watch-video"><i class="bi bi-play-circle"></i><span>Watch Video</span></a>
          </div>
        </div>
